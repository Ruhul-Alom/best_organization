...
?>
 ...
 ?>
  <tr>
    ...
    <td><a  class="btn btn-info" href="../database/user_application_approve.php?userId=<?php echo $data['User_id']; ?>">Approve</a>
      <a  class="btn btn-info" href="fullpostadminView.php?userId=<?php echo $data['User_id']; ?>">Reject</a>
    </td>
