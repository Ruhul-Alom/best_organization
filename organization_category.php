...
<?php  
      ...
      require_once("database/connection.php"); 
          ...
          $query = "SELECT org.Org_id as Org_id, rat.Avg_rat as Avg_rat, org.Org_image as Org_image, org.Org_name as Org_name, org.Org_description as Org_description FROM organization as org left join avg_rating as rat on org.Org_id=rat.Org_id  where Org_category='$org_cat' LIMIT $start_from, $per_page_record";     
...
<div class="search-box col-md-3 pt-2">
 ...
 ?>
    ...
    <div class="card-body col-md-7">
      ...
      echo substr($item['Org_description'],0,300);
     ?>......
      </p>
...
<center>
      ...
      <?php  
        $query = "SELECT COUNT(*) FROM organization where Org_category='org_cat'";     
        $rs_result = mysqli_query($connection, $query);     
    ...
    echo "</br>";     
        ...
        if($page>=2){   
            echo "<a href='organization_category.php?page=".($page-1)."'>  Prev </a>";   
        }       
                   
        for ($i=1; $i<=$total_pages; $i++) {   
          if ($i == $page) {   
              $pagLink .= "<a class = 'active' href='organization_category.php?page="  
                                                .$i."'>".$i." </a>";   
          }               
          else  {   
              $pagLink .= "<a href='organization_category.php?page=".$i."'>   
                                                ".$i." </a>";     
          }   
        };     
        echo $pagLink;   
        ...
        if($page<$total_pages){   
            echo "<a href='organization_category.php?page=".($page+1)."'>  Next </a>";   
        }   
  ...
  <script>   
    ...
    {   
        ...
        window.location.href = 'organization_category.php?page='+page;   
    }   
  </script>  
