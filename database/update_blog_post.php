...
<script src="https://cdn.ckeditor.com/4.14.0/standard/ckeditor.js"></script>
 ...
 <form method="post" action="../database/update_blog_post.php" enctype="multipart/form-data"> 


    <label style="width: 100%">Select Image to upload :</label> <input  type="file" name="blog_image" >
   <br>  <label> Category:</label>
   <select  name="blog_category" style="width: 100%" >
 ...
 ?>
   <option value="<?php echo $fd['Blog_category']; ?>" class="text-dark"> <?php echo $data['Category_name'] ?></option> 

   <?php } ?>
</select> 

 
   <br> <b>Title: </b><input type="text" name="blog_title" style="width: 100%" value="<?php echo $fd['Blog_title']; ?>"  required >
...
/*if((isset($_REQUEST['blog_title'])) && (isset($_REQUEST['blog_category'])) && (isset($_REQUEST['blog_text'])) && (isset($_REQUEST['blog_image']))){*/
...
$updateQuery="UPDATE hr_blog_post SET Blog_title='$blog_post_title', Blog_category='$blog_post_category', Blog_text='$blog_description',Blog_img='$foldername' WHERE Blog_id='$postId'";
